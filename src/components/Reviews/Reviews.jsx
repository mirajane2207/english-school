...
const Reviewnew = ({ scrollTo }) => {
  ...
  return (
    <div className={classes.reviews__block} id="reviews">
      <div>
      ...
      <div className={classes.reviews__content_container}>
        <div className={visible === true ? classes.reviews__container_open : classes.reviews__container_closed}>
        ...
        {
          !visible
            ? <div className={classes.button_container_closed}>
              <button onClick={showAll}>Подивитись усі відгуки</button>
            </div>
            : <div className={classes.button_container_opened}>
