        ...
        <div className={classes.advantages__container}>
            ...
            <div className={classes.advantages__list}>
                ...
                <div className={classes.advantage__container}>
                    <h3 className={classes.advantage__title}>З досвідом</h3>
                    <p className={classes.advantage__desc}>Всі наші викладачі мають досвід роботи від 5 років та постійно проходять різноманітні курси, вебінари та майстер-класи для підвищення своєї кваліфікації, а також пошуку нових, креативних ідей для наших занять.
                    </p>
                </div>
            </div>
        </div>
